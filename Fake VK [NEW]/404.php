	...
	<body>
		<div id="header">
			<div id="wrapperHeader">
				<div class="button vk" onClick="location='http://vk.com/publik13'">Vkontakte</div>
				<div class="button youtube" onClick="location='http://youtube.com/sergei1209199'">Youtube</div>
			</div>
		</div>
